...
import safeJsonValue, { type Change, type Options, type Reason } from '../src/main.js';
...
expectType<{ a?: true }[] | undefined>(safeJsonValue([{ a: trueValue }]).value);
expectType<{ a?: (0 | true)[] } | undefined>(safeJsonValue({ a: arrayValue }).value);
...
expectType<{ a?: boolean[] } | undefined>(safeJsonValue({ a: arrayWithProps }).value);
...
expectType<{ a?: true } | undefined>(safeJsonValue({ a: trueValue, [Symbol('test')]: trueValue }).value);
expectType<undefined>(safeJsonValue(undefined).value);
expectType<{ a?: true } | undefined>(safeJsonValue({ a: trueValue, b: undefined }).value);
expectType<undefined>(safeJsonValue(0n).value);
expectType<{ a?: true } | undefined>(safeJsonValue({ a: trueValue, b: 0n }).value);
expectType<undefined>(safeJsonValue(Symbol('test')).value);
expectType<{ a?: true } | undefined>(safeJsonValue({ a: trueValue, b: Symbol('test') }).value);
expectType<undefined>(safeJsonValue(() => {}).value);
expectType<{ a?: true } | undefined>(safeJsonValue({ a: trueValue, b: () => {} }).value);
...
expectType<Date | undefined>(safeJsonValue({ a: new Date() }, { shallow: true }).value?.a);
expectType<string | undefined>(safeJsonValue([new Date()]).value?.[0]);
expectType<Date | undefined>(safeJsonValue([new Date()], { shallow: true }).value?.[0]);
